...
## Task
The goal of this project is to build a classic Tetris video game using JavaScript, HTML, and CSS, following the Qwasar “My Tetris” quest requirements.
...
Game Over detection
Help text using correct term “Tetriminos”
Legal notice text
